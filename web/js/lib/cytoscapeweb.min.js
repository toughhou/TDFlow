(function() {
	...
	org.cytoscapeweb.Visualization = function(a, b) {
		...
		this.flashInstallerPath = b.flashInstallerPath ? b.flashInstallerPath
				: "playerProductInstall";
		this.flashAlternateContent = b.flashAlternateContent ? b.flashAlternateContent
	...
	org.cytoscapeweb.Visualization.prototype = {
		...
		addNode : function(a, e) {
			var c, d = false, b = 2;
			if (arguments.length > b && typeof arguments[b] === "object") {
				c = arguments[b++]
			}
			if (arguments.length > b && typeof arguments[b] === "boolean") {
				d = arguments[b]
			}
			return this.swf().addNode(a, e, c, d)
		},
		addEdge : function(a) {
			var b = false;
			if (a == null) {
		...
		selected : function(a) {
			return this._nodesAndEdges(a, "getSelectedNodes",
					"getSelectedEdges")
		},
		deselect : function() {
			var b, a;
		...
		embedSWF : function() {
			...
			if (g && !d) {
				...
				AC_FL_RunContent("src", this.flashInstallerPath, "FlashVars",
						"MMredirectURL=" + a + "&MMplayerType=" + b
								+ "&MMdoctitle=" + e + "", "width", "100%",
						"height", "100%", "align", "middle", "id", this.id,
						"quality", "high", "bgcolor", "#ffffff", "name",
						this.id, "allowScriptAccess", "sameDomain", "type",
				...
				if (d) {
					...
					AC_FL_RunContent("src", this.swfPath, "width", "100%",
							"height", "100%", "align", "middle", "id", this.id,
							"quality", "high", "bgcolor", "#ffffff", "name",
							this.id, "allowScriptAccess", "always", "type",
							"application/x-shockwave-flash", "pluginspage",
							"http://www.adobe.com/go/getflashplayer", "wmode",
							"opaque", "flashVars", k)
				} else {
